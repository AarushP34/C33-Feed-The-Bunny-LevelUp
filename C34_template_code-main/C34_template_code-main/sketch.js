...
function setup() 
{
  ...
  star_display.addAnimation("empty", emptyStarImg);
  star_display.addAnimation("one_star", oneStarImg);
  star_display.addAnimation("two_star", twoStarImg);
